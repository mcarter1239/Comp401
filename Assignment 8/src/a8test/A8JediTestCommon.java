...
public class A8JediTestCommon {
	...
	public void testSpoilageCollectorMultiplePlatesDifferentExpirations() throws PlatePriceException, BeltPlateException {
		...
		full_rotate_belt(b);
//		assertEquals(0.75, sc.getTotalSpoiledShellfish(), 0.0001);
		assertEquals(0.75, sc.getTotalSpoiledSeafood(), 0.0001);
		assertEquals(0.75, sc.getTotalSpoiledFood(), 0.0001);
		assertEquals(0.5625, sc.getTotalSpoiledCost(), 0.0001);
		
		full_rotate_belt(b);
		assertEquals(0.75,sc.getTotalSpoiledShellfish(), 0.0001);
		assertEquals(1.5, sc.getTotalSpoiledSeafood(), 0.0001);
		assertEquals(1.5, sc.getTotalSpoiledFood(), 0.0001);
		assertEquals(1.1025, sc.getTotalSpoiledCost(), 0.0001);

		full_rotate_belt(b);
		assertEquals(0.75,sc.getTotalSpoiledShellfish(), 0.0001);
		assertEquals(1.5, sc.getTotalSpoiledSeafood(), 0.0001);
		assertEquals(2.25, sc.getTotalSpoiledFood(), 0.0001);		
		assertEquals(1.925, sc.getTotalSpoiledCost(), 0.0001);
	}
	...
	public void testSpoilageCollectorMultiplePlatesSameExpiration() throws PlatePriceException, BeltPlateException {
		...
		full_rotate_belt(b);
		assertEquals(0, sc.getTotalSpoiledCost(), 0.0001);
		assertEquals(0,sc.getTotalSpoiledShellfish(), 0.0001);
		assertEquals(0, sc.getTotalSpoiledSeafood(), 0.0001);
		assertEquals(0, sc.getTotalSpoiledFood(), 0.0001);
